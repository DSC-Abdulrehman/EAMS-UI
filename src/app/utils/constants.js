...
export const DB_COLUMNS = {
  default: ['_id', 'isDeleted', 'createdAt', 'createdBy', 'updatedAt', 'updatedBy'],
  defaultUpdate: ['isDeleted', 'createdAt', 'createdBy', 'updatedAt', 'updatedBy'],
  roleAccessUpdate: ['slug', 'isDeleted', 'createdAt', 'createdBy', 'updatedAt', 'updatedBy'],
